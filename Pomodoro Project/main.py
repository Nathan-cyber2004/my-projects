...
tomato_img = PhotoImage(file = "C:/Users/Nathan/Desktop/The Complete Guide to Python/Angela Yu Python Programming/Python Projects/Pomodoro Project/tomato.png")
